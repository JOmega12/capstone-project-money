...
export const CreateCategoryTest = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col max-[768px]:justify-center items-center py-8 w-full"
    ...
    >
      ...
      />
      <input
        className="hover:cursor-pointer bg-blue-500 text-white rounded-lg py-2 px-6 w-full max-w-xs
      "
        type="submit"
        value="Enter"
      />
