    ...
    return(
        <div className="flex flex-col max-[768px]:justify-center items-center py-8 ">
            ...
            <div className="py-2 md:w-full lg:px-2">
                {Array.isArray(money) ? (
                    money.map((item) => (
                        <div className="flex md:flex-row gap-6 justify-between border-b mt-6 pb-2" key={item.id}> 
                            ...
                            {editingId === item.id ? (
                                ...
                                <>
                                    ...
                                    <div className="flex-1 text-center">
                                        <p>
                                            {item.transactionType === 'expense'? (`-${item.transactionAmount}`) : (`${item.transactionAmount}`)}    
                                        </p>
                                    </div >
                                    ...
                                    <div className="flex gap-5 mr-10">
                                        ...
                                        "
                                        icon={faTrash} onClick={() => deleteThisTransaction(item.id)}/>    
                                    </div>
